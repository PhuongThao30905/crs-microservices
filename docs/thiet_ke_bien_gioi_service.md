...
| auth-service | 8082 | auth_db | Quản lý User, Student, đăng nhập, sinh/xác thực JWT |
| course-service | 8081 | course_db | Quản lý Course, tìm kiếm, phân trang, quản lý số chỗ |
...
| :--- |:----------------------| :--- |
| /api/auth/** | http://localhost:8082 | Public (login), phần còn lại cần JWT |
| /api/courses/** | http://localhost:8081 | GET public, POST/PUT/DELETE cần role ADMIN |
