...
| :--- |:-----| :--- | :--- |
| api-gateway | 8082 | (không có DB) | Điểm vào duy nhất, định tuyến, xác thực sơ bộ, CORS |
| auth-service | 8081 | auth_db | Quản lý User, Student, đăng nhập, sinh/xác thực JWT |
| course-service | 8080 | course_db | Quản lý Course, tìm kiếm, phân trang, quản lý số chỗ |
...
| /api/courses/** | http://localhost:8080 | GET public, POST/PUT/DELETE cần role ADMIN |
